			...
			<div class="card">
				...
				<div class="card-body">
					<form action="" method="post">
						<input type="hidden" value="<?= $lokasi['id']; ?>">
						<div class="mb-3">
							<label for="namaLokasi" class="form-label">Lokasi</label>
							<input type="text" class="form-control" id="namaLokasi" name="namaLokasi" placeholder="Masukkan nama lokasi proyek"  value="<?= $lokasi['namaLokasi']; ?>">
						</div>
		
						<div class="mb-3">
							<label for="negara" class="form-label">Negara</label>
							<select class="form-select" id="negara" name="negara" value="<?= $lokasi['negara']; ?>" onchange="updateProvinsi()">
						...
						<div class="mb-3">
							...
							<select class="form-select" name="provinsi" id="provinsi" value="<?= $lokasi['provinsi']; ?>" onchange="updateKota()">
								<option value="">Pilih Provinsi</option>
							</select>
						</div>
						<div class="mb-3">
							<label for="kota" class="form-label">Kota</label>
							<select class="form-select" name="kota" id="kota" value="<?= $lokasi['kota']; ?>">
