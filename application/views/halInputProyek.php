				...
				<div class="card-body">
					<form action="" method="post">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="namaProyek" name="namaProyek" placeholder="Masukkan nama proyek">
						</div>

						<div class="mb-3">
							<label for="client" class="form-label">Nama Client</label>
							<input type="text" class="form-control" id="client" name="client" placeholder="Masukkan nama client">
						</div>

						<div class="mb-3">
							<label for="tglmulai" class="form-label">Start Date</label>
							<input type="date" class="form-control" id="tglmulai" name="tglMulai" placeholder="Thn/Bln/Hr">
						</div>

						<div class="mb-3">
							<label for="tglselesai" class="form-label">End Date</label>
							<input type="date" class="form-control" id="tglselesai" name="tglSelesai" placeholder="Thn/Bln/Hr">
						</div>

						<div class="mb-3">
							<label for="pimpinan" class="form-label">Nama Pimpinan Proyek</label>
							<input type="text" class="form-control" id="pimpinan" name="pimpinanProyek" placeholder="Masukkan nama pimpinan proyek">
						</div>

						<div class="mb-3">
							<label for="note" class="form-label">Note</label>
							<input type="text" class="form-control" id="note" name="keterangan" placeholder="keterangan">
						</div>
